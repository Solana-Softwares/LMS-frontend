      ...
      <main className="h-screen w-screen flex relative">
        ...
        <div className="w-full flex flex-col" onClick={closeSideSection}>
          ...
          <div className="bg-[#2b2b2b] h-[90%]">
            <div className="pt-12">
                <img src="sadedit.png" alt="" className="mx-auto" />
            </div>
            <div className="text-white mx-auto flex justify-center pt-10 text-xl text-center">
              You have 0 achievements. <br /> Complete more tasks!
            </div>
          </div>
        </div>
      </main>
